...
const createTodo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const validateUser = utilis_1.creatTodoSchema.validate(req.body, utilis_1.option);
...
const updateTodo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { id } = req.params;
        const validateUser = utilis_1.updateTodoSchema.validate(req.body, utilis_1.option);
        if (validateUser.error) {
            res.status(400).json({ Error: validateUser.error.details[0].message });
        }
